...
pub fn poseidon2(inputs: &[u8]) -> [u64; POSEIDON_DIGEST] {
    todo!("import or impl poseidon2")
}
...
impl Memory {
    ...
    pub fn compute_image_id(&mut self, pc: u32, regiters: &[u8; 39 * 4]) -> ([u8; 32], [u8; 32]) {
        ...
        // let image_id_u64s = poseidon2(&final_data);
        // let image_id = image_id_u64s
        //     .iter()
        //     .flat_map(|&num| num.to_le_bytes())
        //     .collect::<Vec<_>>();
        let image_id = keccak256(&final_data);
