...
use zkm2_zkvm::syscalls::syscall_ed_add;
...
pub fn main() {
    for _ in 0..4 {
        ...
        syscall_ed_add(a1.as_mut_ptr() as *mut [u32; 16] , b1.as_ptr() as *mut [u32; 16]);
        ...
        let mut c1: [u32; 16] = [0; 16];
        for i in 0..16 {
            c1[i] = u32::from_le_bytes([
                c[i * 4],
                c[i * 4 + 1],
                c[i * 4 + 2],
                c[i * 4 + 3],
